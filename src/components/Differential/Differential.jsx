              ...
              <div className={styles.expandedContent}>
                {selectedCard === "rentabilidad" && (
                  <>
                    ...
                    <span>
                      Nuestra prioridad es que tu propiedad alcance la mayor
                      tasa de ocupación al mejor precio posible.
                    </span>
                    <span>
                      Utilizamos estrategias dinámicas de precios, análisis de
                      mercado y optimización del anuncio para que destaque
                      frente a la competencia. Mejoramos la presentación con
                      fotos de alta calidad, descripciones atractivas y
                      posicionamiento en la plataforma para aumentar la
                      visibilidad.
                    </span>
                    <span>
                      Además, ajustamos las tarifas en función de la demanda y
                      las temporadas, asegurando un equilibrio perfecto entre
                      ocupación y rentabilidad.
                    </span>
                    <span>
                      Tú solo disfrutas de los ingresos, nosotros nos ocupamos
                      de todo.
                    </span>
                ...
                {selectedCard === "trato" && (
                  <>
                    ...
                    <span>
                      Sabemos que cada propiedad y cada anfitrión son únicos,
                      por eso adaptamos nuestra gestión a tus necesidades.
                    </span>
                    <span>
                    ...
                    <span>
                      Te ofrecemos un servicio a medida, transparente y
                      flexible, donde tú decides cuánto involucrarte. Nuestro
                      equipo está disponible para resolver cualquier duda y
                      asegurarse de que tu alojamiento funcione a la perfección.
                    </span>
                    <span>
                ...
                {selectedCard === "cobros" && (
                  <>
                    ...
                    <span>
                      ...
                      políticas de cancelación y manejar cualquier incidencia
